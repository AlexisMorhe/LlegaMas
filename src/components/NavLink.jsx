...
export default function NavLink({href, pathname, mobile = false, children}) {
  ...
  if (pathname && mobile){
    ...
    className = 'hidden font-semibold text-up-forest-green sm:inline relative after:absolute after:top-7 after:ml-[-0.5rem] after:left-1/2 after:h-0.5 after:w-4 after:left after:rounded-full after:bg-rainforest after:scale-x-0 after:transition-all hover:after:scale-x-100'
  }
